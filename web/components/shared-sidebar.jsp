...
<aside id="sidebar" class="sidebar-fixed w-[280px] shrink-0 bg-slate-900 text-white flex flex-col h-screen shadow-2xl shadow-slate-950/40">
    ...
    <nav class="sidebar-nav flex-1 py-4 px-3 space-y-1">
        ...
        <a href="MainController?action=listCustomer" class="flex items-center gap-3 px-3 py-2.5 rounded-xl <%= "customer".equals(activePage) ? "bg-teal-500/20 text-teal-300 font-semibold shadow-inner shadow-teal-900/30 ring-1 ring-teal-400/20" : "text-slate-300 hover:bg-slate-800/90 hover:text-white" %> transition-all duration-200">
            <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
            Khách Hàng
        </a>
        <a href="MainController?action=listSupplier" class="flex items-center gap-3 px-3 py-2.5 rounded-xl <%= "supplier".equals(activePage) ? "bg-teal-500/20 text-teal-300 font-semibold shadow-inner shadow-teal-900/30 ring-1 ring-teal-400/20" : "text-slate-300 hover:bg-slate-800/90 hover:text-white" %> transition-all duration-200">
        ...
        <a href="MainController?action=listRouting" class="flex items-center gap-3 px-3 py-2.5 rounded-xl <%= "routing".equals(activePage) ? "bg-teal-500/20 text-teal-300 font-semibold shadow-inner shadow-teal-900/30 ring-1 ring-teal-400/20" : "text-slate-300 hover:bg-slate-800/90 hover:text-white" %> transition-all duration-200">
        ...
        <a href="UserController?action=listUser" class="flex items-center gap-3 px-3 py-2.5 rounded-xl <%= "user".equals(activePage) ? "bg-teal-500/20 text-teal-300 font-semibold shadow-inner shadow-teal-900/30 ring-1 ring-teal-400/20" : "text-slate-300 hover:bg-slate-800/90 hover:text-white" %> transition-all duration-200">
    ...
    <div class="sidebar-footer border-t border-slate-700 p-4 relative">
        ...
        <div id="sidebarUserMenu" class="hidden absolute bottom-full left-2 right-2 mb-1 py-1.5 bg-slate-800 rounded-xl border border-slate-700 shadow-xl z-50">
            ...
            <a href="UserController?action=logoutUser" class="flex items-center gap-2 px-3 py-2.5 rounded-lg text-red-400 hover:bg-red-500/20 text-sm transition-all duration-200">Đăng Xuất</a>
        </div>
    </div>
</aside>
