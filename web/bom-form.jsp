...
<html>
    ...
    <body>
        ...
        <form action="MainController" method="post">
            ...
            Parent Item ID: <input type="number" name="parentItemId" value="${bom.parentItemID}" required/><br/>
            Child Item ID: <input type="number" name="childItemId" value="${bom.childItemID}" required/><br/>
            Quantity: <input type="number" step="0.01" name="quantity" value="${bom.quantity}" required/><br/>
